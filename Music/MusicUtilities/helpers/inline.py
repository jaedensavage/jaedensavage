...
def play_markup(videoid, user_id):
    buttons= [
            ...
            [
                InlineKeyboardButton(text=f"✨ ɢʀᴏᴜᴘ", url=f"https://t.me/FULL_MASTI_CLUBS"),
                InlineKeyboardButton(text=f"📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/heartbrokenperson1"),
            ],
            [      
...
def others_markup(videoid, user_id):
    buttons= [
            [
                InlineKeyboardButton(text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/full_masti_clubs"),
