        ...
        if user.id == from_user.id:
            ...
            for sex in served_chats:
                try:
                    ...
                    pass    
            ban_text = f"""
__**New Global Ban List On katil Music**__\n
...
async def chat_watcher_func(_, message):
    ...
    if await is_gbanned_user(userid):
        try:
            ...
            return       
        await message.reply_text(f"{checking} is globally banned by katil Music and has been kicked out of the chat.\n\n**Possible Reason:** Potential Spammer and Abuser.")
