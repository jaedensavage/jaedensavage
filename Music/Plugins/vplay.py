...
from Music.config import ALEXIA_SUPPORT, UPDATES_CHANNEL
...
async def vplay(c: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/FULL_MASTI_CLUBS"),
                InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/heartbrokenperson1"),
            ]
        ]
    )
...
» Add user 
» Manage voice chat 
Powered by : [katil Music](t.me/{BOT_USERNAME})
""",
