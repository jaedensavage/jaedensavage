...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO KATIL SERVER")
        try:
    ...
    for served_chat in served_chats:
        try:
            ...
            print("Error came while clearing db")
            pass     
    await app.send_message(LOG_GROUP_ID, "KATIL�KATIL𝙈𝙪𝙨𝙞𝙘 𝘽𝙤𝙩 𝙎𝙩𝙖𝙧𝙩𝙚𝙙")
    await client.send_message(LOG_GROUP_ID, "𝘼𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩 𝙊𝙛 KATIL 𝙈𝙪𝙨𝙞𝙘 𝙎𝙩𝙖𝙧𝙩𝙚𝙙")
    print("[INFO]: STARTED THE KATIL BOT AND SENDING THE INFO TO KATIL SERVER")
